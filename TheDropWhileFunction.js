...
Your task is to implement the dropWhile function. If you've got a span function lying around, this is a one-liner! Alternatively, 
if you have a takeWhile function on your hands, then combined with the dropWhile function, you can implement the span function in one line. 
...
function dropWhile(arr, pred) {
  ...
  return breakIndex !== null ? arr.slice(breakIndex) : [];
}
...
console.log(dropWhile([2, 4, 10, 100, 64, 78, 92], isEven));
