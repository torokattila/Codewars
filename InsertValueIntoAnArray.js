/*Extend the Array object with the function insert(index,value). This function must change the original 
array and insert the value at the given index in the array.
...
Object.defineProperty(Array.prototype, 'insert', {
    ...
    value: function (index, number) {
        if (index > this.length) {
            this.splice(index, this.indexOf([this.length - 1]), number);
        } else {
