...
all the duplicates of a particular number. Subarrays should be in the same order as the first occurence of the number they contain:
...
function group(arr) {
    ...
    uniques.forEach((num) => {
        result.push(arr.filter((arrItem) => arrItem === num));
    });
