...
0s and 1s as parameters. There is no need to test the parameters for validity (but you can, if you want).
...
function hammingDistance(a, b) {
	return a.split('').filter((char, index) => b.charAt(index) !== char).length;
}
