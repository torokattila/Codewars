/*For this Kata you will need to create a function which works out the score of a dive in an Olympic diving competition and displays 
it in the correct format. The function will take 2 arguments:
...
function scoreOfDive(scores, tariff) {
    ...
    const restScores = sortedScores.slice(2, -2);
    const result =
        restScores.reduce((accum, current) => accum + current) * tariff;
