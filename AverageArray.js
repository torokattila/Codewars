/*Create a function that takes a 2D array as an input, and outputs another array that contains the average values 
...
function avgArray(arr) {
    ...
    for (let i = 0; i < arr.length; i++) {
        for (let j = 0; j < arr[i].length; j++) {
            averagesArray[j] = ((averagesArray[j] || 0) + + arr[i][j] / lengthOfArray)
        }
    }
