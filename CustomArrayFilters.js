...
Array.prototype.even = function () {
    ...
    return array.filter((num) => Number.isInteger(num) && num % 2 === 0);
};
...
Array.prototype.under = function (x) {
    ...
    return array.filter((num) => Number.isInteger(num) && num < x);
};
...
Array.prototype.inRange = function (min, max) {
    ...
    return array.filter((num) => Number.isInteger(num) && num >= min && num <= max);
};

const arr = [1, 2, 18, 19, 20, 21, 22, 30, 40, 50, 100];

console.log(arr.even().inRange(18, 30));
