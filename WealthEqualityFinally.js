...
The function should mutate the input such that every index has the same amount of wealth. MUTATE the input array/list, don't return anything.
...
function redistributeWealth(wealth) {
    const average =
        wealth.reduce((accum, current) => accum + current) / wealth.length;
