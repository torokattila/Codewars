...
function testResult(array) {
	let average = Number(
		(array.reduce((a, b) => a + b) / array.length).toFixed(3)
	);
	const marksCounter = {
		h: 0,
		a: 0,
	...
	let onlyHighMarks = marksCounter['h'] > 0 && marksCounter['a'] === 0 && marksCounter['l'] === 0;

	return onlyHighMarks ? [average, marksCounter, 'They did well'] : [average, marksCounter];
}
