...
To do this, you must first count the 'mini-wins' on your ticket. Each subarray has both a string 
and a number within it. If the character code of any of the characters in the string matches the number, 
...
function bingo(ticket, win) {
    ...
    ticket.forEach((element) => {
        [...new Set(element[0].split(''))].forEach((char) => {
