...
consecutive terms of a given series of numbers. You are provided with consecutive elements of an Arithmetic Progression. 
...
var findMissing = function (list) {
    ...
    const sum = (length + 1) * (list[0] + list[length - 1]) / 2;
    
    return sum - list.reduce((accum, current) => accum + current);
};
