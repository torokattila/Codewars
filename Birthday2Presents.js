...
One even explodes and covers you in soil... strange office. To make up for this one present is a dog! Happy days! 
(do not buy dogs as presents, and if you do, never wrap them).
...
console.log(present('empty', 3));
console.log(present('bang', 8));
