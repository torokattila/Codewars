/*My friend wants a new band name for her band. She like bands that use the formula: "The" + a noun with the 
...
function bandNameGenerator(str) {
    ...
    if (str.charAt(0) == str.slice(-1)) {
        bandName += str.charAt(0).toUpperCase() + str.slice(1) + str.slice(1);
    } else {
