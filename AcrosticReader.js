...
https://treasuredpoem.com/Acrostic-Poem.html
...
and will need to return a string corresponding to the word that is spelled out by taking the first 
letter of each word in the acrostic.*/

function readOut(acrostic) {
	return acrostic.map(word => word.charAt(0)).join("");
}
